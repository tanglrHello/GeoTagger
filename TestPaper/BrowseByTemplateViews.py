...
def browseByTemplate(request):
    ...
    if request.method=='POST' and "template" in request.POST:   #查询某种模板的所有句子的请求
        ...
        return render_to_response("BrowseByTemplate.html",
                                ...
                                "templateSeltected":request.POST['template'][:-5],  #remove 'Radio' at the end of this string
                                'papertype':papertype,
                                #t_type:True,
        ...
        #templateType=request.POST['ExtractTemplateType']    #模板类型,高阶模板还是二阶模板
